...
beautiful.font              = "Hack-Regular 10"
beautiful.notification_font = "Hack-Bold 14"
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey,           }, "w", function () mymainmenu:show() end,
		...
		awful.key({ modkey, "Control" }, "=", function () lain.util.useless_gaps_resize(1) end,
							{description = "make cool gaps bigger", group = "gaps"}),
		awful.key({ modkey, "Control" }, "-", function () lain.util.useless_gaps_resize(-1) end,
							{description = "make cool gaps smaller", group = "gaps"}),					
...
-- Autostart
awful.spawn.with_shell("~/.config/polybar/madbar.sh")
